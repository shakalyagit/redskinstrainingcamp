...
$(function(){
    ...
    var wraperHeight = winHeight - mainHeader;
    $('.content-wrapper').css('min-height', wraperHeight);
    ...
    if(pageName != "")
    {
        if($("a[href='"+pageName+".html']").length)
        {
            if($("a[href='"+pageName+".html']").parent().parent().hasClass('treeview-menu'))
            {
                $("a[href='"+pageName+".html']").parent().addClass('active1');
                $("a[href='"+pageName+".html']").closest('ul').parent().addClass('active');
            }else
            {
                $("a[href='"+pageName+".html']").parent().addClass('active');
            }
        }
    }
})
